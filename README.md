...
Filósofo Aristóteles está comendo 🍽️
    </pre>
    ...
    <ul>
        ...
        <li>Animação da mesa</li>
        <li>Logs detalhados</li>
        <li>Mais filósofos dinâmicos</li>
    </ul>
